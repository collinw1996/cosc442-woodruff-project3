...
/**
 * The class <code>VendingMachineItemTestCodePro</code> contains tests for the class <code>{@link VendingMachineItem}</code>.
 *
 * @generatedBy CodePro at 3/7/18 7:00 PM
 * @author Collin
 * @version $Revision: 1.0 $
 */
public class VendingMachineItemTestCodePro {
	/**
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(VendingMachineItemTestCodePro.class);
	}
}